        ...
        <div class="row">
            <div class="col-md-11 col-lg-8">
                ...
                <div class="modal-instance block">
                    <div class="video-play-icon video-play-icon--sm bg--primary modal-trigger"></div>
                    <span>
                        <strong>Watch our film</strong>&nbsp;&nbsp;&nbsp;104 Seconds</span>
