<section class="height-100">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1><?php App::show(Route::title($_GET['url']))?></h1>
                <ol class="breadcrumbs">
                    <li>This Application collects some Personal Data from its Users.</li>
                </ol>
                <hr>
                <!--Beginning of summary policy-->
                <div class = "orionP-summary">
                    <div class="col-md-12">
                        <h2>Policy summary</h2>
                    </div>
                    <hr>
                    <h4 id="purposes_data">Personal Data collected for the following purposes and using the following services:</h2>
                    <div class="row">
                        <div class="col-md-6">
                            <div class = "row">
                                <div class="col-md-3">
                        ...
                        <div class="col-md-6">
                            <div class = "row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <ul class="unstyled">
                                        <li> 
                                            <p>Valley view university, Oyibi, Accra, Ghana</p>
                                            <p>Owner contact email: info@orionic.tech</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        The Data processing is carried out using computers and/or IT enabled tools, following organizational procedures and modes strictly related to the purposes 
                        indicated. In addition to the Owner, in some cases, the Data may be accessible to certain types of persons in charge, involved with the operation of this Application 
                        (administration, sales, marketing, legal, system administration) or external parties (such as third-party technical service providers, mail carriers, hosting providers,
                        IT companies, communications agencies) appointed, if necessary, as Data Processors by the Owner. The updated list of these parties may be requested from the Owner at any time.</p>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4>Mode and place of processing the Data</h4>
                        <p>
                            The Data concerning the User is collected to allow the Owner to provide its Services, as well as for the following purposes: Analytics, Advertising and Hosting and backend infrastructure.
                        </p>
